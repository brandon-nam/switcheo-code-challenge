...
func (*Ledger) Descriptor() ([]byte, []int) {
	return fileDescriptor_70bcf16f3db512de, []int{0}
}
...
func (m *Ledger) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Ledger)(nil), "ledger.ledger.Ledger")
}

func init() { proto.RegisterFile("ledger/ledger/ledger.proto", fileDescriptor_70bcf16f3db512de) }

var fileDescriptor_70bcf16f3db512de = []byte{
	// 174 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Ledger) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Cost != 0 {
		i = encodeVarintLedger(dAtA, i, uint64(m.Cost))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Creator) > 0 {
	...
	if len(m.Body) > 0 {
		i -= len(m.Body)
		copy(dAtA[i:], m.Body)
		i = encodeVarintLedger(dAtA, i, uint64(len(m.Body)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintLedger(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
